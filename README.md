...
If confirmed by independent testing, this would make it one of the strongest non-NNUE chess engines written in Python, and very likely the strongest written in MicroPython.
